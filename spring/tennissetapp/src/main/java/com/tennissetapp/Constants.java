...
public class Constants {
	...
	public interface ProfileType {
		String TENNIS_PLAYER = "TENNIS_PLAYER";
		String TENNIS_TEACHER = "TENNIS_TEACHER";
	}
	...
	public interface GCM {
		 ...
		 * registration_id. The client needs to re-register with the GCM servers
		...
		/**
		 * A particular message could not be sent because the GCM servers were
		 * not available. Used only on JSON requests, as in plain text requests
		...
		/**
		 * Token returned by GCM when the requested registration id has a
		 * canonical value.
		 */
		...
		/**
		 * JSON-only field representing the error field of an individual
		 * request.
		 */
