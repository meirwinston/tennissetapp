  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $("<fieldset class='birthday-picker'></fieldset>"),
          $year = $("<select class='birth-year theme1' name='birthYear'></select>"),
          $month = $("<select class='birth-month theme1' name='birthMonth'></select>"),
          $day = $("<select class='birth-day theme1' name='birthDay'></select>");
